...
kg/prize-draw/2.0.0/index
kg/prize-draw/2.0.0/mini
 ...
 * @module prize-draw
 **/
//KISSY.add('kg/prize-draw/2.0.0/index',function (S, Node,Base) {
//    var EMPTY = '';
//    var $ = Node.all;
//    /**
//     *
...
KISSY.add(function (S, Node, Base) {
    ...
    S.extend(PrizeDraw, Base, {
        ...
        initStyle:function(){
            ...
            var blinkCss='@-webkit-keyframes blink { 0% {background: #00a651;} 25% {background: #00aeef;} 50% {background: #ffdc7b;} 2.0.0% {background: #00a651;}}';
            styleStr+=choosedCss;
            styleStr+=blinkCss;
            styleStr+='</style>';
 ...
 * @module prize-draw
 **/
KISSY.add('kg/prize-draw/2.0.0/mini',function(S, Component) {
